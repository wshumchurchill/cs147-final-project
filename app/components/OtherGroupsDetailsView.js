...
export default function OtherGroupDetailsView({ navigation, route }) {
    ...
    const uploadData = async () => {
        ...
        navigation.navigate('OtherGroupsScreen')
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.listContainer}>
                <View style={styles.section}>
                    <Text style={styles.choosemembers}>Edit viewing preferences</Text>
                </View>
                <FlatList
                    data={NAMES}
            ...
            <View style={styles.FloatingButton}>
                <Pressable onPress={uploadData}>
                    <Text style={styles.QuestionText}>Save Preferences</Text>
                </Pressable>
            </View>
